    ...
    <div class="page-container">
      ...
      <div *ngIf="detail" class="detail-content">
        ...
        <div class="detail-info">
          ...
          <div class="detail-field"><span class="label">Expected Delivery:</span><span class="value">{{ detail.expectedDeliveryDate | date:'mediumDate' }}</span></div>
        </div>
        <h3>Order Lines</h3>
...
export class OrderDetailComponent implements OnInit {
  ...
  loadDetail(id: number): void {
    this.loading = true;
    this.apiService.getDetail<OrderDetail>('orders', id).subscribe({
