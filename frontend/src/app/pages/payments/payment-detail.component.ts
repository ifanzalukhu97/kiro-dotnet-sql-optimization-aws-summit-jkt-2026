  ...
  template: `
    <div class="page-container">
      ...
      <div *ngIf="detail" class="detail-content">
        <h1>Payment #{{ detail.customerTransactionId }}</h1>
        ...
        <div class="detail-info">
          <div class="detail-field"><span class="label">Amount:</span><span class="value">{{ detail.transactionAmount | currency }}</span></div>
          <div class="detail-field"><span class="label">Tax:</span><span class="value">{{ detail.taxAmount | currency }}</span></div>
          <div class="detail-field"><span class="label">Outstanding Balance:</span><span class="value">{{ detail.outstandingBalance | currency }}</span></div>
        </div>
      </div>
    </div>
  `,
...
export class PaymentDetailComponent implements OnInit {
  ...
  loadDetail(id: number): void {
    this.loading = true;
    this.apiService.getDetail<PaymentDetail>('payment', id).subscribe({
